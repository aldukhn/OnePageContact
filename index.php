...
<head>
  ...
  <title>Inpie</title>
  <meta name="description" content="InPie">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="icon" type="image/png" href="images/logo/Icon-High232323.png">  <!-- Include Bootstrap Css -->
  ...
  <!-- Include Style Css -->
  <link rel="stylesheet" href="assets/css/style.min1.css">
  <!-- Include Responsive Css -->
  <link rel="stylesheet" href="assets/css/responsive.min1.css">
...
<body oncontextmenu="return false">
  ...
  <header id="masthead" class="masthead navbar ">
    <div class="container">
      ...
      <div class="navbar-header" >
        ...
        <a class="navbar-brand" href="./"><img src="images/logo/Icon-logo-last2.png" alt="Site Logo"></a>
      </div>
  ...
  <section id="main-slider" class="main-slider text-center">
    <div class="head-overlay">
      <ul class="bxslider">
        <li>
          <div class="head-overlay">
            <img src="images/slider/B - Designing.jpg"/>
          </div><!-- /.head-overlay -->
          <div class="slider-text">
            <div class="our-skills wow animated fadeInRight" data-wow-delay=".5s">
              <div class="slide-inner">
              <h2 class="slider-title">Welcome to <bl>InPie</bl> </h2>
              <p class="slide-description"><g><bl>Where</bl> Dreams <bl>become</bl> codes</g></p>
    ...
    <div class="about-top">
      <div class="section-padding">
        <div class="container">
              ...
              <center>  <h2 class="section-title">We are <span>InPie</span></h2> </center><!-- /.section-title -->

              <p>
InPie is a small start-up firm located in Hadhramout, Yemen. We offer full digital services to small and large businesses. The services we offer include website development and design, hosting, maintenance, marketing, mobile application and others.
We believe we can offer a unique and superior service to small business owners, in comparison to what is currently available.
When it comes to your digital services .. we are who you want ..
                </p><!-- /.description -->
          ...
          <div class="item media wow animated fadeInLeft" data-wow-delay=".35s">
            <div class="section-padding">
              <div class="item-no media-left">
                <span class="count text-right"></span>
              </div><!-- /.item-no -->
              <div class="item-details media-body text-center">
                ...
                <div class="countdown">
                  <span class="count-number counter">2</span>
                </div><!-- /.coundown -->
                <span class="about-item">PROJECTS COMPLETED</span>
              </div><!-- /.item-details -->
            </div><!-- /.section-padding -->
          </div><!-- /.item -->
        </div>
          ...
          <div class="item media wow animated fadeInLeft" data-wow-delay=".55s">
            <div class="section-padding">
              ...
              <div class="item-details media-body text-center">
                ...
                <div class="countdown">
                  <span class="count-number counter">4</span>
                </div><!-- /.coundown -->
                <span class="about-item">CURRENT PROJECTS</span>
              </div><!-- /.item-details -->
            </div><!-- /.section-padding -->
          </div><!-- /.item -->
        </div>
          ...
          <div class="item media wow animated fadeInLeft" data-wow-delay=".75s">
            <div class="section-padding">
              ...
              <div class="item-details media-body text-center">
                ...
                <div class="countdown">
                  <span class="count-number counter">18</span>
                </div><!-- /.coundown -->
                <span class="about-item">PROGRAMMING LANGUAGES</span>
              </div><!-- /.item-details -->
            </div><!-- /.section-padding -->
          </div><!-- /.item -->
        </div>
          ...
          <div class="item media wow animated fadeInLeft" data-wow-delay=".95s">
            <div class="section-padding">
              ...
              <div class="item-details media-body text-center">
                ...
                <span class="about-item">CLIENTS</span>
              </div><!-- /.item-details -->
            </div><!-- /.section-padding -->
          </div><!-- /.item -->
        </div>
      ...
      <div class="section-padding">
        <div class="col-sm-6">
          <div class="tab-image wow animated fadeInLeft" data-wow-delay=".5s">
            <img src="images/Design-2.jpg" alt="Tab Image">
          </div><!-- /.tab-image -->
        </div>

        <div class="col-sm-6">
          <div class="our-skills wow animated fadeInRight" data-wow-delay=".5s">
            <h2 class="section-title"><span>Our</span> areas of expertise</h2><!-- /.section-title -->
            <div class="skill-bars">
              <div class="progress">
                <div class="progress-bar" role="progressbar" aria-valuenow="89" aria-valuemin="0" aria-valuemax="100" style="width: 89%;">
                  <span class="skill-name">Java Program</span>89%
                </div>
              </div>
              <div class="progress">
                <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%;">
                  <span class="skill-name">Web Development</span>70%
                </div>
              </div>
              <div class="progress">
                <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;">
                  <span class="skill-name">Objective-C</span>60%
                </div>
              </div>
            </div><!-- /.skill-bars -->
          </div><!-- /.our-skills -->
  ...
  <section id="services" class="services text-center">
    <div class="section-padding">
          ...
          <div class="section-top wow animated fadeInUp" data-wow-delay=".5s">
            <h2 class="section-title"><span>Our </span>Services</h2>
            <p class="section-description">
We provide a world class services to fulfill your business needs. Apart of these services we InPie provide support and host to all our products.            </p><!-- /.section-description -->
          </div><!-- /.section-top -->
            <div>
           ...
           <div class="service-details">
              <div class="col-md-3 col-sm-6">
                <div class="item wow animated fadeInLeft" data-wow-delay=".5s">
                  ...
                  <div class="item-details">
                    <h4 class="item-title">Android Apps Developement</h4><!-- /.item-title -->
              ...
              <div class="col-md-3 col-sm-6">
                <div class="item wow animated fadeInLeft" data-wow-delay=".35s">
                  ...
                  <div class="item-details">
                    <h4 class="item-title">Website Development</h4><!-- /.item-title -->
                    <p class="item-description">
                    </p><!-- /.item-description -->
                  </div><!-- /.item-details -->
                </div><!-- /.item -->
              ...
              <div class="col-md-3 col-sm-6">
                <div class="item wow animated fadeInRight" data-wow-delay=".3s">
                  <div class="item-icon">
                    <i class="fa fa-apple"></i>
                  </div><!-- /.item-icon -->
                  <div class="item-details">
                    <h4 class="item-title">Ios Apps Developement</h4><!-- /.item-title -->
                    <p class="item-description">
                    </p><!-- /.item-description -->
...
<!-- ************************************************************* -->
      <!--    <div class="col-md-3 col-sm-6">
        ...
        <!--         <div class="item-details">
                    <h4 class="item-title">Web Hosting and Support</h4> --><!-- /.item-title -->
          <!--        <p class="item-description">
                   </p> --><!-- /.item-description -->
        <!--        </div>  --><!-- /.item-details -->
        <!--       </div>  --> <!-- /.item -->
...
<!--    ************************************************************************************** -->
  <!-- Subscribe Section -->
<!--
  <section id="subscribe-section" class="subscribe-section text-center" data-stellar-background-ratio="1" data-stellar-vertical-offset="0">
<div class="section-padding">
    <div class="bg-overlay">

        <div class="container">
          <div class="wow animated fadeInUp" data-wow-delay=".5s">
            <h2 class="section-title">Polmo WordPress Version Is Cooming Soon!</h2>    -->
...
<!--
          <div id="project-items" class="project-items">
            <div class="item cat-1 cat-4">
              <a href="images/project/1.jpg" class="image-popup-vertical-fit">
  ...
  <section id="testimonial" class="testimonial text-center" data-stellar-background-ratio="0.1" data-stellar-vertical-offset="0">
    <div class="pattern-overlay">
      <div class="section-padding">
        <div class="container">
          <div class="section-top wow animated fadeInUp" data-wow-delay=".5s">
            <h2 class="slider-title"> <bl>InPie</bl</h2><!-- /.section-title -->
          </div><!-- /.section-top -->
            ...
            <div id="testimonial-slider" class="testimonial-slider carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner" role="listbox">
                <div class="item active">
                  <blockquote class="slide-description">
                  <g> You <b><bl>SAY</bl></b> it, we <b><bl>CODE</bl></b> it </g>
    ...
    <div class="contact-inner">
      ...
      <div class="form-area text-center wow animated fadeInRight" data-wow-delay=".75s">
        ...
        <form action="email.php" method="post" id="contactform" class="contactform">
         <input id="name" class="form-control" name="name" type="text" placeholder="Name" value="" required = "true"/>
          <input id="email" class="form-control pull-right" name="email" type="email" placeholder="Email" value="" required = "true"/>
          <textarea id="message" class="form-control" name="message" placeholder="Your Message" rows="5" required></textarea>
<button name="submit" class="btn submit-btn" type="submit" id="submit" value="Submit">Send Message</button>
        ...
        <div class="col-xs-4">
          <div class="social-item wow animated fadeInRight" data-wow-delay=".75s">
            <div class="section-padding">
              ...
              <!--<div class="countdown">
                <span class="count-number counter"></span>
              </div>--><!-- /.coundown -->
              <span class="about-item">@AbdulrahmanHDH</span>
            </div><!-- /.section-padding -->
          </div><!-- /.social-item -->
        </div>
        ...
        <div class="col-xs-4">
          <div class="social-item wow animated fadeInRight" data-wow-delay=".35s">
            ...
            <!--  <div class="countdown">
              ...
              <span class="about-item">abd.aldukhn@gmail.com</span>
            </div><!-- /.section-padding -->
          </div><!-- /.social-item -->
        </div>
      </div><!-- /.social-contact -->
...
<!-- Footer Section -->
  ...
  <!-- Google Maps Script -->
  <script src="http://maps.google.com/maps/api/js?sensor=true&key=AIzaSyDE2--QMIxTFppzkZnPNUHwKdzuRrri8A8"></script>
